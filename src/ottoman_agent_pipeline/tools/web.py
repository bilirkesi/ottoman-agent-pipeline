...
class WebSearchTool(BaseTool):
    ...
    async def initialize(self) -> None:
        ...
        self._client = httpx.AsyncClient(
            ...
            headers={"User-Agent": "OttomanAgent/1.0 (research@bilirkesi.ai)"},
        )
    ...
    async def execute(
        self, action: str, query: str = "", url: str = "", **kwargs
    ) -> Any:
        """
    ...
    async def _search(
        ...
        try:
            ...
            results = self._parse_duckduckgo_results(
                response.text, kwargs.get("max_results", self.max_results)
            )
    ...
    def _extract_entities(self, text: str) -> list[dict[str, str]]:
        ...
        return [{"type": "person", "value": p} for p in persons[:10]] + [
