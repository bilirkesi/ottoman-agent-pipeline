...
async def list_workflows(
    status: str | None = None, limit: int = Query(100, ge=1, le=1000)
):
    """
...
async def get_workflow_executions(
    workflow_id: str, limit: int = Query(100, ge=1, le=1000)
):
    """
...
async def clone_workflow(workflow_id: str, request: dict = Body(...)):
    """
    Workflow klonla
    """
    try:
...
async def get_template(template_id: str):
    ...
    try:
        ...
        return {"template_id": template_id, "workflow": workflow.to_dict()}
